...
const SELECTED_LIST_ID_KEY = 'task.selectedListsId'
let lists = JSON.parse(localStorage.getItem(LIST_KEY)) || []
let selectedListId = localStorage.getItem(SELECTED_LIST_ID_KEY)
...
function save () {
    ...
    localStorage.setItem(SELECTED_LIST_ID_KEY, selectedListId)
}
